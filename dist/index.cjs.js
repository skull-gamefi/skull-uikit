...
var Icon$B = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React__default['default'].createElement("g", { clipPath: "url(#clip0)" },
            ...
            React__default['default'].createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#b0acb8" }),
            React__default['default'].createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#b0acb8" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#b0acb8" })),
            ...
            React__default['default'].createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#b0acb8" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#b0acb8" }))),
        React__default['default'].createElement("defs", null,
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #b0acb8, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
...
var Icon$16 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("g", { transform: "translate(0.000000,24.000000) scale(0.004687,-0.004687)", stroke: "none" },
            React__default['default'].createElement("path", { d: "M1114 5105 c-248 -54 -457 -241 -543 -485 -14 -40 -26 -56 -43 -61\n-116 -33 -240 -111 -330 -208 -80 -87 -122 -158 -161 -268 -27 -77 -31 -105\n-35 -219 -4 -110 -1 -144 17 -214 55 -218 195 -391 396 -490 103 -51 177 -70\n300 -77 115 -6 232 12 325 52 l55 24 300 -300 300 -299 -300 -299 -300 -300\n-55 24 c-142 60 -356 71 -505 25 -259 -80 -451 -281 -516 -540 -18 -70 -21\n-104 -17 -214 4 -114 8 -142 35 -219 39 -110 81 -181 161 -268 92 -99 199\n-165 344 -213 10 -3 18 -11 18 -19 0 -7 12 -42 26 -78 90 -221 298 -395 533\n-445 99 -21 262 -18 356 6 213 55 387 196 485 395 51 103 70 177 77 300 6 113\n-12 228 -51 326 l-24 57 299 298 299 299 299 -300 300 -300 -24 -55 c-60 -142\n-71 -357 -25 -505 81 -260 281 -451 540 -516 121 -31 310 -24 425 15 207 70\n380 230 459 425 14 36 26 71 26 78 0 8 8 16 18 19 252 82 427 250 508 489 39\n114 46 304 15 425 -55 218 -195 391 -396 490 -103 51 -177 70 -300 77 -115 6\n-232 -12 -325 -52 l-55 -24 -300 300 -300 299 300 299 300 300 55 -24 c93 -40\n210 -58 325 -52 123 7 197 26 300 77 201 99 341 272 396 490 18 70 21 104 17\n214 -4 114 -8 142 -35 219 -17 48 -46 112 -64 143 -49 81 -149 186 -227 238\n-68 44 -178 96 -207 96 -9 0 -18 8 -21 18 -79 241 -229 405 -454 495 -87 34\n-164 47 -285 47 -332 0 -613 -211 -715 -535 -46 -148 -35 -363 25 -505 l24\n-55 -300 -300 -299 -300 -299 299 -299 298 24 57 c56 140 68 338 30 486 -68\n258 -281 469 -541 535 -92 24 -265 26 -361 5z m358 -337 c228 -113 319 -368\n212 -593 -10 -21 -44 -73 -76 -114 l-57 -76 392 -393 392 -392 -208 -207 -207\n-208 -392 392 -393 392 -76 -57 c-150 -115 -267 -145 -414 -107 -302 79 -431\n421 -258 682 79 120 192 180 374 198 l66 7 12 94 c6 52 19 113 28 136 49 127\n148 221 279 268 47 16 78 20 155 17 88 -2 103 -6 171 -39z m2542 4 c89 -42\n145 -87 188 -154 49 -75 66 -125 79 -232 l12 -94 66 -7 c136 -14 215 -43 297\n-111 128 -104 187 -308 136 -471 -61 -196 -257 -327 -462 -310 -100 8 -172 42\n-301 141 l-45 35 -1217 -1217 -1216 -1217 57 -76 c65 -84 89 -129 108 -204 48\n-178 -43 -391 -208 -488 -118 -69 -279 -76 -403 -19 -88 41 -144 87 -187 154\n-49 75 -66 125 -79 232 l-12 94 -66 7 c-182 18 -295 78 -374 198 -169 255 -51\n587 242 677 148 46 276 16 430 -102 l76 -57 1217 1216 1217 1217 -35 45 c-99\n129 -133 201 -141 301 -17 203 112 397 307 462 41 13 79 17 150 15 83 -2 104\n-7 164 -35z m-419 -2832 l390 -389 85 64 c47 36 110 75 140 86 233 90 507 -44\n582 -284 25 -80 24 -191 -3 -269 -59 -177 -199 -284 -400 -309 l-96 -12 -12\n-96 c-25 -204 -131 -340 -313 -402 -51 -17 -80 -20 -154 -17 -81 3 -100 8\n-166 41 -225 111 -319 365 -216 584 12 25 48 80 80 122 l57 76 -392 392 -392\n393 205 205 c113 113 207 205 210 205 3 0 180 -175 395 -390z" }))));
};
...
var RugDoc = styled__default['default'].div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject([""], [""])));
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null,
        ...
        React__default['default'].createElement(MenuEntry, { key: "rugdoc", style: { height: 100 } },
            React__default['default'].createElement(RugDoc, { style: {
                ...
                }, role: "button", "aria-label": "Hide or show expandable content", onClick: function () { var _a; return window !== null && ((_a = window.open("https://rugdoc.io/project/skullgamefi/", "_target")) === null || _a === void 0 ? void 0 : _a.focus()); } })),
        React__default['default'].createElement(MenuEntry, { key: "wtf", style: { height: 100 } },
            React__default['default'].createElement(RugDoc, { style: {
...
var Network = styled__default['default'].div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  line-height: 32px;\n  color: ", ";\n  margin: 0 10px;\n  font-weight: 800;\n"], ["\n  line-height: 32px;\n  color: ", ";\n  margin: 0 10px;\n  font-weight: 800;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.secondary;
});
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children, network = _a.network;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(Network, null, network),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#cbc6d5", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
